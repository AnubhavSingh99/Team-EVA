...
import f1 from "../../assets/HomeImg/f1.png";
import f2 from "../../assets/HomeImg/f2.png";
import f3 from "../../assets/HomeImg/f3.png";
          ...
          <div className="-m-8 flex flex-wrap items-center justify-between">
            <div className="w-auto p-8">
              <a href="#">
                ...
                <p className="text-white text-sm">
                  Department of Agriculture & Farmers Welfare Ministry of
                </p>
                <p className="text-white text-sm">
            ...
            <div className="w-auto p-8">
              <ul className="flex items-start flex-col">
                <li className="p-2">
                  <a
                    className="font-small text-white hover:text-gray-700"
                    href="#"
                  >
                    Home
                  </a>
            ...
            <div className="w-auto p-8">
              <div className="-m-1.5 flex flex-wrap">
                <div className="w-auto p-1.5">
                  <a href="#">
                    <div className="flex object-fill h-15 w-15">
                      <img src={f1} alt="" />
                    </div>
                  </a>
                </div>
                <div className="w-auto p-1.5">
                  <a href="#">
                    <div className="flex object-fill h-15 w-20">
                      <img src={f2} alt="" />
                    </div>
                  </a>
                </div>
